...
<!-- Modal Alterar Senha-->
<div class="modal fade" id="modal-regularizacao-documentos-projeto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="${path}/painel/projetos/${projeto.id}/documentos/reenviar" method="post" enctype="multipart/form-data" acceptcharset="UTF-8">
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <textarea class="form-control text-justify" name="analise" rows="7" maxlength="3000" placeholder="" readonly>${projeto.documentosProjeto.pareceresDocumentacao[0].analise}</textarea>
              </div>
              <fieldset class="mt-2 mb-2">
                ...
                <div class="row justify-content-start'">
                  ...
                  <c:if test="${projeto.documentosProjeto.propostaTecnica.status eq 'NEGADO'}">
                    ...
                    <div class="col-xl-6 text-center pt-3">
                        <div class="form-group">
                            <label for="propostaTecnica"><i class="far fa-file-pdf text-primary" style="font-size: 56px;"></i></label>
                            <hr>
                            <h5 class="text-center">Proposta Técnica</h5>
                            <input type="file" id="propostaTecnica" name="propostaTecnica.file" onchange="validaPdf(this, this.id)" required>
                        </div>
                    </div>                  
                  </c:if>
                  <c:if test="${projeto.documentosProjeto.propostOrcamentaria.status eq 'NEGADO'}">
                    ...
                    <div class="col-xl-6 text-center pt-3">
                        <div class="form-group">
                            <label for="propostOrcamentaria"><i class="far fa-file-pdf text-primary" style="font-size: 56px;"></i></label>
                            <hr>
                            <h5 class="text-center">Planilha Orçamentária</h5>
                            <input type="file" id="propostOrcamentaria" name="propostOrcamentaria.file" onchange="validaImgPdf(this, this.id)" required>
                        </div>
                    </div>
                  </c:if>
                  <c:if test="${projeto.documentosProjeto.certificado.status eq 'NEGADO'}">
                    ...
                    <div class="col-xl-6 text-center pt-3">
                        <div class="form-group">
                            ...
                            <input type="file" id="certificado" name="certificado.file" onchange="validaImgPdf(this, this.id)" required>
                        </div>
                    </div>
                  </c:if>
                  <c:if test="${projeto.documentosProjeto.dadosBancariosFundo.status eq 'NEGADO'}">
                    ...
                    <div class="col-xl-6 text-center pt-3">
                        <div class="form-group">
                            <label for="dadosBancariosFundo"><i class="far fa-file-pdf text-primary" style="font-size: 56px;"></i></label>
                            <hr>
                            <h5 class="text-center">Dados Bancários do Fundo</h5>
                            <input type="file" id="dadosBancariosFundo" name="dadosBancariosFundo.file" onchange="validaImgPdf(this, this.id)" required>
                        </div>
                    </div>
                  </c:if>
                </div>
