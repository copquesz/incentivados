...
<c:forEach var="modalMotivoReprovado" items="${recusados}">
    <div class="modal fade" id="modal-motivo-reprovado-${modalMotivoReprovado.id}" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title">Relatório de Pedido <strong>#${modalMotivoReprovado.id}</strong></h5>
                        ...
                        <div class="col-12">
                            <c:if test="${usuario.tipoUsuario.id != 0}">
                                ...
                                <p class="text-justify"><fmt:formatDate type="both" dateStyle="short" timeStyle="short"
                                                                        value="${modalMotivoReprovado.observacaoPedido.dataCadastro}"/></p>
                                <hr>
                            </c:if>
                            <c:if test="${usuario.tipoUsuario.id != 0}">
