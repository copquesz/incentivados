...
<!-- Modal Regularização Documentos Entidade -->
<div class="modal fade" id="modal-regularizacao-documentos-entidade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="${path}/painel/entidades/${entidade.id}/documentos/reenviar" method="post"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control text-justify" name="analise" rows="7" maxlength="3000"
                                          placeholder=""
                                          readonly>${entidade.documentosEntidade.pareceresDocumentacao[0].analise}</textarea>
                            </div>
                            <fieldset class="mt-2 mb-2">
                                ...
                                <div class="row justify-content-start'">
                                    ...
                                    <c:if test="${entidade.documentosEntidade.ataEleicao.status eq 'NEGADO'}">
                                        ...
                                        <div class="col-xl-6 text-center pt-3">
                                            <div class="form-group">
                                                <label for="ataEleicao"><i class="far fa-file-pdf text-primary"
                                                                           style="font-size: 56px;"></i></label>
                                                <hr>
                                                <h5 class="text-center">Ata de Eleição</h5>
                                                <input type="file" id="ataEleicao" name="ataEleicao.file"
                                    ...
                                    <c:if test="${entidade.documentosEntidade.estatutoSocial.status eq 'NEGADO'}">
                                        ...
                                        <div class="col-xl-6 text-center pt-3">
                                            <div class="form-group">
                                                <label for="estatutoSocial"><i class="far fa-file-pdf text-primary"
                                                                               style="font-size: 56px;"></i></label>
                                                <hr>
                                                <h5 class="text-center">Estatuto Social ou Contrato Social</h5>
                                                <input type="file" id="estatutoSocial" name="estatutoSocial.file"
                                                       onchange="validaPdf(this, this.id)" required>
                                            </div>
                                        </div>
                                    </c:if>
                                    <c:if test="${entidade.documentosEntidade.identidade.status eq 'NEGADO'}">
                                        ...
                                        <div class="col-xl-6 text-center pt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="identidade" name="identidade.file"
                                    ...
                                    <c:if test="${entidade.documentosEntidade.cartaoCnpj.status eq 'NEGADO'}">
                                        ...
                                        <div class="col-xl-6 text-center pt-3">
                                            <div class="form-group">
                                                <label for="cartaoCnpj"><i class="far fa-file-pdf text-primary"
                                                                           style="font-size: 56px;"></i></label>
                                                <hr>
                                                <h5 class="text-center">Cartão CNPJ</h5>
                                                <input type="file" id="cartaoCnpj" name="cartaoCnpj.file"
                                                       onchange="validaImgPdf(this, this.id)" required>
                                            </div>
                                        </div>
                                    </c:if>
                                    <c:if test="${entidade.documentosEntidade.dadosBancarios.status eq 'NEGADO'}">
                                        ...
                                        <div class="col-xl-6 text-center pt-3">
                                            <div class="form-group">
                                                <label for="dadosBancarios"><i class="far fa-file-pdf text-primary"
                                                                               style="font-size: 56px;"></i></label>
                                                <hr>
                                                <h5 class="text-center">Dados Bancários</h5>
                                                <input type="file" id="dadosBancarios" name="dadosBancarios.file"
                                                       onchange="validaImgPdf(this, this.id)" required>
                                            </div>
                                        </div>
                                    </c:if>
