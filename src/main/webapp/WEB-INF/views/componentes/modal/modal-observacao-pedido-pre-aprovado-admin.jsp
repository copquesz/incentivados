...
<!-- Modal Observação Pedido Pré Aprovado Admin -->
<c:forEach var="modalPedidoPreAprovadoUsuario" items="${pedidos.content}">
    <div class="modal fade" id="modal-observacao-pedidopre-aprovado-admin-${modalPedidoPreAprovadoUsuario.id}"
         tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title">Relatório de Pedido <strong>#${modalPedidoPreAprovadoUsuario.id}</strong>
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <p class="text-justify"><strong>Este pedido foi pré-aprovado. A partir de agora é necessário
                                aguardar os trâmites internos para finalizarmos o processo de aprovação.</strong></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-12">
                            <c:if test="${usuario.tipoUsuario.id != 0}">
                                ...
                                <p class="text-justify"><fmt:formatDate type="both" dateStyle="short" timeStyle="short"
                                                                        value="${modalPedidoPreAprovadoUsuario.observacaoPedido.dataCadastro}"/></p>
                                <hr>
