...
<c:forEach var="modalPedidoRecusado" items="${recusados.content}">
    <div class="modal fade" id="modal-observacao-pedido-recusado-${modalPedidoRecusado.id}" tabindex="-1" role="dialog"
                        ...
                        <div class="col-12">
                            <c:if test="${usuario.tipoUsuario.id != 0}">
                                ...
                                <p class="text-justify"><fmt:formatDate type="both" dateStyle="short" timeStyle="short"
                                                                        value="${modalPedidoRecusado.observacaoPedido.dataCadastro}"/></p>
                                <hr>
                            </c:if>
                            <c:if test="${usuario.tipoUsuario.id != 0}">
