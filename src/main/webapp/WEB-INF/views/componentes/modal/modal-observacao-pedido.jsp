...
<c:forEach var="modalPedido" items="${pedidos.content}">
  <div class="modal fade" id="modal-observacao-pedido-${modalPedido.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header bg-info">
          <h5 class="modal-title text-white">Relatório de Pedido <strong>#${modalPedido.id}</strong></h5>
          ...
          <div class="row">
            <div class="col-12">
              <c:if test = "${usuario.tipoUsuario.id != 0}">
                ...
                <p class="text-justify"><fmt:formatDate type = "both" dateStyle = "short" timeStyle = "short" value = "${modalPedido.observacaoPedido.dataCadastro}"/></p>
                <hr>
              </c:if>
              <c:if test = "${usuario.tipoUsuario.id != 0}">
