...
<div class="modal fade" id="modal-welcome" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 text-justify">
                            ...
                            <p>Para ter uma ótima experiência por aqui, preparamos um tutorial com informações sobre
                                como navegar e suas funcionalidades.</p>
                            <p>Nesta sua primeira visita você pode acessá-lo clicando no no botão abaixo. E, sempre que
                                precisar pelo menu de navegação no canto esquerdo no item <strong
                                        style="color: #72bf44;">TUTORIAL</strong>.
