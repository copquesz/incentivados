                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                <ul>
                                    <li>Entidades com documentação irregular:
                                        <strong>${entidadesNegadoAnalise.totalElements}</strong></li>
                                    <c:if test="${not empty entidadesNegadoAnalise.content}">
                                        <ul style="margin-top: 10px;">
                                            <c:forEach var="entidadeNegadoAnalise"
                                                       items="${entidadesNegadoAnalise.content}">
                                                <strong><a href="${path}/painel/entidades/${entidadeNegadoAnalise.id}"
                                                           title="Visualizar" class="text-primary">
                                                    <li>${entidadeNegadoAnalise.nomeFantasia}</li>
                                                </a></strong>
                                            </c:forEach>
                                        </ul>
                                    </c:if>
                                    ...
                                    <hr>
                                    <li>Projetos com documentação irregular:
                                        <strong>${projetosNegadoAnalise.totalElements}</strong></li>
                                    <c:if test="${not empty projetosNegadoAnalise.content}">
                                        <ul style="margin-top: 10px;">
                                            <c:forEach var="projetoNegadoAnalise"
                                                       items="${projetosNegadoAnalise.content}">
                                                <strong><a href="${path}/painel/projetos/${projetoNegadoAnalise.id}"
                                                           title="Visualizar" class="text-primary">
                                                    <li>${projetoNegadoAnalise.titulo}</li>
                                                </a></strong>
                                            </c:forEach>
                                        </ul>
                                    </c:if>
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <c:forEach var="entidade" items="${entidades.content}">
                                                    <tr>
                                                        <td class="text-center border"><img class=""
                                                                                            src="${path}/${entidade.documentosEntidade.logo.path}"
                                                                                            style="max-width: 6rem; max-height: 3rem;">
                                                        </td>
                                                        ...
                                                        <td class="text-center border">
                                                            <a href="${path}/painel/entidades/${entidade.id}"
                                            ...
                                            <c:forEach var="projeto" items="${projetos.content}">
                                                <div class="col-12 col-xl-3 col-lg-6 col-md-6 d-flex align-items-stretch bd-highlight">
                                                    <div class="card border align-self-stretch flex-fill bd-highlight mt-3">
                                                        ...
                                                        <div class="card-body">
                                                            <h5 class="card-title"
                                                                style="font-weight: bold;">${projeto.titulo}</h5>
                                                            <hr>
                                                            <p class="card-text text-justify">${fn:substring(projeto.objetivo, 0, 180)}
                                                                ...</p>
                                                        </div>
                                                        <div class="card-footer">
                ...
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-header ">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="${path}/painel/pedidos/cadastro?empresaCnpj=01.438.784/0001-05"
                                       class="btn btn-primary float-right"><i class="fas fa-plus mr-2"></i> Cadastrar
                                        Pedido</a>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center border">
                                                    ...
                                                    <c:if test="${pedido.status.id == 1}">
                                                        <span class="bg-danger p-1"><a class="text-white" href="#"
                                                                                       data-toggle="modal"
                                                                                       data-target="#modal-observacao-pedido-${pedido.id}"
                                                                                       title="Visualizar">REPROVADO</a></span>
                                                    </c:if>
                                                    <c:if test="${pedido.status.id == 2}">
                                                        <span class="bg-success p-1"><a class="text-white" href="#"
                                                                                        data-toggle="modal"
                                                                                        data-target="#modal-observacao-pedido-${pedido.id}"
                                                                                        title="Visualizar">APROVADO</a></span>
                                                    </c:if>
                                                    <c:if test="${pedido.status.id == 3}">
                                                        <span class="bg-success p-1"><a class="text-white" href="#"
                                                                                        data-toggle="modal"
                                                                                        data-target="#modal-observacao-pedidopre-aprovado-usuario-${pedido.id}"
                                                                                        title="Visualizar">PRÉ-APROVADO</a></span>
                                                    </c:if>
                                                </th>
                                            </tr>
                                        </c:forEach>
