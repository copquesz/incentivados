                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body bg-danger">
                            <p class="text-white"><span class="bold">Projeto: ${projeto.titulo}</span> já possui
                                registro na plataforma. Tente novamente informando outro título.</p>
                            <p>
                                <a href="${path}/painel/projetos/cadastro" class="btn btn-warning rounded"><i
                                        class="fas fa-angle-double-left"></i> Tentar Novamente</a>
                                <a href="${path}/painel/dashboard" class="btn btn-warning rounded  ml-2"><i
                                        class="fas fa-list-ul"></i> Voltar</a></p>
                        </div>
