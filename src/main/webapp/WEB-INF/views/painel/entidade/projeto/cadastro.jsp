                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body border">
                            <form action="${path}/painel/projetos/cadastro" method="post" enctype="multipart/form-data"
                                  acceptcharset="UTF-8">
                                ...
                                <fieldset>
                                    ...
                                    <select class="selectpicker form-control" name="entidade" title="Selecione ..."
                                ...
                                <fieldset class="mt-5">
                                    ...
                                    <select class="selectpicker form-control" id="selectpicker-incentivo-fiscal"
                                            name="incentivosFiscais" multiple title="Selecione ..."
                                            data-live-search="true" data-style="btn-info" required>
                                        <optgroup label="Categoria">
                                            <c:forEach var="incentivoFiscal" items="${incentivosFiscais}">
                                                <option value="${incentivoFiscal.id}">${incentivoFiscal.legislacao}
                                                    (${incentivoFiscal.competencia.descricao})<c:if
                                                            test="${not empty incentivoFiscal.sigla}"> - ${incentivoFiscal.sigla}</c:if></option>
                                            </c:forEach>
                                        </optgroup>
                                    </select>
                                </fieldset>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="prazo-captacao"
                                                       name="prazoCaptacao" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="valor-solicitado"
                                                       name="valorSolicitado" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <label>Valor Total:</label>
                                                <input type="text" class="form-control" id="valor-total"
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="beneficiarios-direto"
                                                       name="beneficiariosDiretos" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <label>Beneficiários Indiretos:</label>
                                                <input type="text" class="form-control" id="beneficiarios-indireto"
                                                       name="beneficiariosIndiretos" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="contrapartida" rows="5"
                                                          maxlength="3000"
                                                          placeholder="Cite as estratégias de contrapartida ..."
                                                          required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="objetivo" rows="5" maxlength="3000"
                                                          placeholder="Descreva o seu objetivo ..." required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Resumo:</label>
                                                <textarea class="form-control" name="resumo" rows="10" maxlength="3000"
                                                          placeholder="Apresente um resumo do projeto ..."
                                                          required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-start">
                                        <div class="col-sm-12 col-md-6 text-center mt-5">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="logo" name="documentosProjeto.logo.file"
                                                       onchange="validaImg(this, this.id)" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6 text-center mt-5">
                                            <div class="form-group">
                                                <label for="proposta-tecnica"><i class="far fa-file-pdf text-primary"
                                                                                 style="font-size: 56px;"></i></label>
                                                <hr>
                                                <h5 class="text-center">Proposta Técnica</h5>
                                                <input type="file" id="proposta-tecnica"
                                                       name="documentosProjeto.propostaTecnica.file"
                                                       onchange="validaPdf(this, this.id)" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6 text-center mt-5">
                                            <div class="form-group">
                                                <label for="proposta-orcamentaria"><i
                                                        class="far fa-file-pdf text-primary"
                                                        style="font-size: 56px;"></i></label>
                                                <hr>
                                                <h5 class="text-center">Proposta Orçamentária</h5>
                                                <input type="file" id="proposta-orcamentaria"
                                                       name="documentosProjeto.propostOrcamentaria.file"
                                                       onchange="validaImgPdf(this, this.id)" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6 text-center mt-5"
                                             id="campo-dados-bancarios-fundo">
                                            <div class="form-group">
                                                <label for="dados-bancarios-fundo"><i
                                                        class="far fa-file-pdf text-primary"
                                                        style="font-size: 56px;"></i></label>
                                                <hr>
                                                <h5 class="text-center">Dados Bancários do Fundo</h5>
                                                <input type="file" id="dados-bancarios-fundo"
                                                       name="documentosProjeto.dadosBancariosFundo.file"
                                                       onchange="validaImgPdf(this, this.id)">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6 text-center mt-5" id="campo-certificado">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="certificado"
                                                       name="documentosProjeto.certificado.file"
                                                       onchange="validaImgPdf(this, this.id)">
                                            </div>
                                        </div>
                                    </div>
