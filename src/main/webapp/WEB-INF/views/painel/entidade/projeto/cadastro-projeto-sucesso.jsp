                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body bg-success">
                            ...
                            <p>
                                <a href="${path}/painel/dashboard" class="btn btn-warning"><i
                                        class="far fa-share-square"></i> Voltar</a>
                                <a href="${path}/painel/projetos" class="btn btn-warning"><i
                                        class="far fa-share-square"></i> Ver Projetos</a>
                            </p>
                        </div>
