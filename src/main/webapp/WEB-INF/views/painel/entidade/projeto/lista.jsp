                          ...
                          <ul class="pagination">
                            <c:choose>
                              <c:when test = "${projetos.totalPages == 1}">
                                ...
                                <li class="page-item active"><a class="page-link text-branco" href="${path}/painel/projetos?page=${projetos.number}">${projetos.number + 1}</a></li>
                              ...
                              <c:when test = "${(projetos.totalPages == 2) && (projetos.number + 1 < projetos.totalPages)}">
                                <li class="page-item"><button class="page-link text-primary" disabled>Primeira</button></li>
                                <li class="page-item active"><a class="page-link text-primary text-branco" href="${path}/painel/projetos?page=${projetos.number}">${projetos.number + 1}</a></li>
