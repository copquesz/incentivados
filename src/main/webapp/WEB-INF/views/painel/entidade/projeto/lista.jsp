                                                        ...
                                                        <c:choose>
                                                            <c:when test="${projetos.totalPages == 1}">
                                                                ...
                                                                <li class="page-item active"><a
                                                                        ...
                                                                        href="${path}/painel/projetos?page=${projetos.number}">${projetos.number + 1}</a>
                                                                </li>
                                                                <li class="page-item">
                                                                    <button class="page-link text-primary" disabled>
                                                                        Última
                                                            ...
                                                            <c:when test="${(projetos.totalPages == 2) && (projetos.number + 1 < projetos.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number + 1}">${projetos.number + 2}</a>
                                                                </li>
                                                                <li class="page-item">
                                                                    <button class="page-link text-primary" disabled>
                                                                        Última
                                                            ...
                                                            <c:when test="${(projetos.totalPages == 2) && (projetos.number + 1 == projetos.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number - 1}">${projetos.number}</a>
                                                                </li>
                                                                <li class="page-item active"><a
                                                                        class="page-link text-primary text-white"
                                                                        href="${path}/painel/projetos?page=${projetos.number}">${projetos.number + 1}</a>
                                                            ...
                                                            <c:when test="${(projetos.totalPages >= 3) && (projetos.number == 0)}">
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos">Primeira</a>
                                                                </li>
                                                                <li class="page-item active"><a
                                                                        class="page-link text-white"
                                                                        href="${path}/painel/projetos?page=${projetos.number}">${projetos.number + 1}</a>
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number + 2}">${projetos.number + 3}</a>
                                                                </li>
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.totalPages - 1}">Última</a>
                                                                </li>
                                                            </c:when>
                                                            ...
                                                            <c:when test="${(projetos.totalPages >= 3) && (projetos.number + 1 == projetos.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number - 2}">${projetos.number - 1}</a>
                                                                </li>
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number - 1}">${projetos.number}</a>
                                                                </li>
                                                    ...
                                                    <div class="card border align-self-stretch flex-fill bd-highlight mt-3">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text text-justify">
                                                                <c:choose>
                                                                    <c:when test="${fn:length(projeto.objetivo) > 180}">
                                                                        ${fn:substring(projeto.objetivo, 0, 180)} ...
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        ${projeto.objetivo}
                                                                    </c:otherwise>
