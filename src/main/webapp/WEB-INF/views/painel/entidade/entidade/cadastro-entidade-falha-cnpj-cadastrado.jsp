...
<head>
  ...
  <title>
    Incentivados - Cadatsro de Entidade
  </title>
  ...
  <div class="main-panel">
    ...
    <div class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header bg-danger"><h4 class="card-title text-branco bold"><i class="far fa-thumbs-down fa-2x"></i> Falha!</h4><hr></div>
            <div class="card-body bg-danger">
              <p class="text-branco"><span class="bold">CNPJ: ${empresa.cnpj}</span> já possui registro na plataforma. Tente novamente informando outros dados.</p>
              <p>
                <a href="${path}/painel/entidades/cadastro" class="btn btn-warning rounded"><i class="fas fa-angle-double-left"></i> Voltar</a>
                <a href="${path}/painel/entidades" class="btn btn-warning rounded  ml-2"><i class="fas fa-list-ul"></i> Ver Registros</a></p>
            </div>
