                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="${usuario.endereco.logradouro}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bairro"
                                                   value="${usuario.endereco.bairro}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cidade"
                                                   value="${usuario.endereco.cidade}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="estado"
                                                   value="${usuario.endereco.estado}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
