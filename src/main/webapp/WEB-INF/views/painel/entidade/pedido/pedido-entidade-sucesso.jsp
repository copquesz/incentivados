    ...
    <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
      <div class="container-fluid">
        <div class="navbar-wrapper">
          ...
          <b><a class="navbar-brand" href="#">Pedidos <i class='fas fa-angle-double-right'></i> ${empresa.nomeFantasia} <i class='fas fa-angle-double-right'></i> Cadastro</a></b>
        </div>
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body bg-success">
              <p class="text-branco bold">Código Pedido: ${pedido.id}</br>Solicitante: ${pedido.usuario.nome} ${pedido.usuario.sobrenome} - ${pedido.entidade.nomeFantasia}</br>Patrocinador: ${pedido.empresa.nomeFantasia}</br>Loja: ${pedido.analista.endereco.bairro} - ${pedido.analista.endereco.cidade} / ${pedido.analista.endereco.estado}</p>
              <p class="text-branco">O pedido foi solicitado com sucesso na plataforma.</p>
