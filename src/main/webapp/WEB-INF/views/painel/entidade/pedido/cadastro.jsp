            ...
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">Pedidos <i
                            class='fas fa-angle-double-right'></i> ${empresa.nomeFantasia} <i
                            class='fas fa-angle-double-right'></i> Cadastro</a></b>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body border">
                            <form action="${path}/painel/pedidos/cadastro" method="post" enctype="multipart/form-data"
                                  acceptcharset="UTF-8">
                                <fieldset>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="${usuario.nome} ${usuario.sobrenome}" readonly required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <select class="selectpicker form-control" name="tipoPedido"
                                                    title="Selecione ..." data-live-search="true"
                                                    data-style="btn-primary" required>
                                                <c:forEach var="tipoPedido" items="${tiposPedido}">
                                                    <option value="${tipoPedido}"
                                                            required>${tipoPedido.descricao}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="col-6">
                                            <label>Entidade:</label>
                                            <select class="selectpicker form-control" name="entidade.id"
                                                    title="Selecione ..." data-live-search="true"
                                                    data-style="btn-primary" required>
                                                <c:forEach var="entidade" items="${entidades}">
                                                    <option value="${entidade.id}" required>${entidade.razaoSocial}
                                                        - ${entidade.cnpj}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="solicitacao" rows="10"
                                                          maxlength="3000" placeholder="Descreva sua solicitação ..."
                                                          required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <fieldset class="mt-5">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="${empresa.nomeFantasia}"
                                                       readonly required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="${empresa.razaoSocial}"
                                                       readonly required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <label>Loja:</label>
                                            <select class="selectpicker form-control" name="analista.id"
                                                    title="Selecione ..." data-live-search="true"
                                                    data-style="btn-primary" required>
                                                <c:forEach var="analista" items="${empresa.analistas}">
                                                    <option value="${analista.id}"
                                                            data-content='<strong><i class="far fa-building"></i> ${analista.endereco.bairro}</strong> (${analista.endereco.cidade} - ${analista.endereco.estado})'
                                                            required></option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                ...
                                <fieldset class="mt-5 mb-5">
                                    ...
                                    <div class="row justify-content-start">
                                        <div class="col-lg-2 text-center mt-5">
                                            <div class="form-group">
                                                <label for="carta-oficio"><i class="far fa-file-alt text-primary"
                                                                             style="font-size: 56px;"></i></label>
                                                <hr>
                                                <h5 class="text-center">Carta Oficio</h5>
                                                <input type="file" id="carta-oficio"
                                                       name="documentosPedido.cartaOficio.file"
