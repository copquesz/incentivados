    ...
    <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
      <div class="container-fluid">
        <div class="navbar-wrapper">
          ...
          <b><a class="navbar-brand" href="#">Pedidos <i class='fas fa-angle-double-right'></i> ${usuario.empresa.nomeFantasia} <i class='fas fa-angle-double-right'></i>  #${pedido.id}</a></b>
        </div>
