        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">Pedidos <i
                            class='fas fa-angle-double-right'></i> ${empresa.nomeFantasia}</a></b>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="10" placeholder="Não Informado"
