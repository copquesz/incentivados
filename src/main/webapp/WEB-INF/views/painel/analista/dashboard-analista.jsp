                    ...
                    <div class="card ">
                        <div class="card-body">
                            <ul class="nav nav-pills" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active bg-warning text-white border" id="pendentes-tab"
                                       data-toggle="tab" href="#pendentes" role="tab" aria-controls="pendentes"
                                       aria-selected="true">Pendentes: ${pendentes.totalElements}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link bg-warning text-white border" id="pre-aprovados-tab"
                                       data-toggle="tab" href="#pre-aprovados" role="tab" aria-controls="pre-aprovados"
                                       aria-selected="true">Pré-Aprovados: ${preAprovados.totalElements}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link bg-success text-white border" id="aprovados-tab"
                                       data-toggle="tab" href="#aprovados" role="tab" aria-controls="aprovados"
                                       aria-selected="false">Aprovados: ${aprovados.totalElements}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link bg-danger text-white border" id="recusados-tab" data-toggle="tab"
                                       href="#recusados" role="tab" aria-controls="recusados" aria-selected="false">Recusados: ${recusados.totalElements}</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                                        ...
                                                        <c:forEach var="pedidoPendente" items="${pendentes.content}">
                                                            <tr>
                                                                ...
                                                                <fmt:formatDate type="both" dateStyle="short"
                                                                                timeStyle="short"
                                                                                value="${pedidoPendente.dataCadastro}"
                                                                                var="dataCadastro"/>
                                                                ...
                                                                <td class="text-center border"><a
                                                                        ...
                                                                        href="${path}/painel/pedido/${pedidoPendente.id}"
                                                                        title="Avaliar"><i
                                                                        class="fas fa-sign-in-alt"></i></a></td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    </table>
                                ...
                                <div class="tab-pane fade show" id="pre-aprovados" role="tabpanel"
                                     aria-labelledby="pre-aprovados-tab">
                                            ...
                                            <div class="col-12">
                                                <div class="table-responsive pr-3">
                                                    <table class="table border">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="pedidoPreAprovado"
                                                                   items="${preAprovados.content}">
                                                            <tr>
                                                                <td class="text-center border">${pedidoPreAprovado.id}</td>
                                                                <fmt:formatDate type="both" dateStyle="short"
                                                                                timeStyle="short"
                                                                                value="${pedidoPreAprovado.dataCadastro}"
                                                                                var="dataCadastro"/>
                                                                <td class="text-center border">${dataCadastro}</td>
                                                                ...
                                                                <td class="text-center border">${pedidoPreAprovado.analista.endereco.bairro}
                                                                    - ${pedidoPreAprovado.analista.endereco.cidade}
                                                                    / ${pedidoPreAprovado.analista.endereco.estado}</td>
                                                                <td class="text-center border">${pedido.tipoPedido.descricao}</td>
                                                                <td class="text-center border"><a href="#"
                                                                                                  data-toggle="modal"
                                                                                                  data-target="#modal-observacao-pedido-pre-aprovado-${pedidoPreAprovado.id}"
                                                                                                  title="Visualizar"><i
                                ...
                                <div class="tab-pane fade show" id="aprovados" role="tabpanel"
                                                    ...
                                                    <table class="table border">
                                                        ...
                                                        <c:forEach var="pedidoAprovado" items="${aprovados.content}">
                                                            <tr>
                                                                ...
                                                                <fmt:formatDate type="both" dateStyle="short"
                                                                                timeStyle="short"
                                                                                value="${pedidoAprovado.dataCadastro}"
                                                                                var="dataCadastro"/>
                                                                <td class="text-center border">${dataCadastro}</td>
                                                                ...
                                                                <td class="text-center border">${pedidoAprovado.analista.endereco.bairro}
                                                                    - ${pedidoAprovado.analista.endereco.cidade}
                                                                    / ${pedidoAprovado.analista.endereco.estado}</td>
                                                                <td class="text-center border">${pedido.tipoPedido.descricao}</td>
                                                                <td class="text-center border"><a href="#"
                                                                                                  data-toggle="modal"
                                                                                                  data-target="#modal-observacao-pedido-aprovado-${pedidoAprovado.id}"
                                                                                                  title="Visualizar"><i
                                                                        class="far fa-file-pdf"></i></a></td>
                                                            </tr>
                                                        </c:forEach>
                                ...
                                <div class="tab-pane fade show" id="recusados" role="tabpanel"
                                     aria-labelledby="recusados-tab">
                                            ...
                                            <div class="col-12">
                                                <div class="table-responsive pr-3">
                                                    <table class="table border">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="pedidoRecusado" items="${recusados.content}">
                                                            <tr>
                                                                <td class="text-center border">${pedidoRecusado.id}</td>
                                                                <fmt:formatDate type="both" dateStyle="short"
                                                                                timeStyle="short"
                                                                                value="${pedidoRecusado.dataCadastro}"
                                                                                var="dataCadastro"/>
                                                                <td class="text-center border">${dataCadastro}</td>
                                                                <td class="text-center border">${pedidoRecusado.entidade.nomeFantasia}</td>
                                                                <td class="text-center border">${pedidoRecusado.empresa.nomeFantasia}</td>
                                                                <td class="text-center border">${pedidoRecusado.analista.endereco.bairro}
                                                                    - ${pedidoRecusado.analista.endereco.cidade}
                                                                    / ${pedidoRecusado.analista.endereco.estado}</td>
                                                                <td class="text-center border">${pedido.tipoPedido.descricao}</td>
                                                                <td class="text-center border"><a href="#"
                                                                                                  data-toggle="modal"
                                                                                                  data-target="#modal-observacao-pedido-recusado-${pedidoRecusado.id}"
                                                                                                  title="Visualizar"><i
                                                                        class="far fa-file-pdf"></i></a></td>
                                                            </tr>
                                                        </c:forEach>
