                      ...
                      <ul class="pagination">
                        <c:choose>
                          <c:when test = "${pedidos.totalPages == 1}">
                            ...
                            <li class="page-item active"><a class="page-link text-branco" href="${path}/painel/pedidos?page=${pedidos.number}&filtro=${filtro}&key=${key}">${pedidos.number + 1}</a></li>
                          ...
                          <c:when test = "${(pedidos.totalPages == 2) && (pedidos.number + 1 < pedidos.totalPages)}">
                            <li class="page-item"><button class="page-link text-primary" disabled>Primeira</button></li>
                            <li class="page-item active"><a class="page-link text-primary text-branco" href="${path}/painel/pedidos?page=${pedidos.number}&filtro=${filtro}&key=${key}">${pedidos.number + 1}</a></li>
                        ...
                        <c:forEach var="pedido" items="${pedidos.content}">
                          <tr>
                            ...
                            <td class="text-center border">
                              <c:if test = "${pedido.status.id == 0}"><span class="bg-warning p-1 text-branco">PENDENTE</span></c:if>
                              <c:if test = "${pedido.status.id == 1}"><span class="bg-danger p-1"><a href="#" class="text-branco" data-toggle="modal" data-target="#modal-observacao-pedido-recusado-${pedido.id}" title="Visualizar Motivo">RECUSADO</a></span></c:if>
                              <c:if test = "${pedido.status.id == 2}"><span class="bg-success p-1"><a href="#" class="text-branco" data-toggle="modal" data-target="#modal-observacao-pedido-aprovado-${pedido.id}" title="Visualizar Motivo">APROVADO</a></span></c:if>
                              <c:if test = "${pedido.status.id == 3}"><span class="bg-success p-1"><a href="#" class="text-branco" data-toggle="modal" data-target="#modal-observacao-pedidopre-aprovado-admin-${pedido.id}" title="Visualizar Motivo">PRÉ-APROVADO</a></span></c:if>
                            </td>
                            <td class="text-center border">
