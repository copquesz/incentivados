        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">projeto <i
                            class='fas fa-angle-double-right'></i> ${projeto.titulo} <i
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="${path}/painel/projetos/${projeto.id}/documentos/analise" method="post"
                              acceptcharset="UTF-8" id="formulario-analise-documentos-projeto">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <c:if test="${not empty projeto.documentosProjeto.logo.path}">
                                                            ...
                                                            <input type="hidden" name="logo.path"
                                                                   value="${projeto.documentosProjeto.logo.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${projeto.documentosProjeto.logo.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            href="${path}/${projeto.documentosProjeto.logo.path}"
                                                                            target="_blank"
                                                        ...
                                                        <c:if test="${not empty projeto.documentosProjeto.propostaTecnica.path}">
                                                            ...
                                                            <input type="hidden" name="propostaTecnica.path"
                                                                   value="${projeto.documentosProjeto.propostaTecnica.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${projeto.documentosProjeto.propostaTecnica.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            href="${path}/${projeto.documentosProjeto.propostaTecnica.path}"
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Proposta Técnica</a></td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-proposta-tecnica"
                                                                               name="propostaTecnica.status"
                                                                               type="radio" value="APROVADO"
                                                                               checked><label
                                                                            for="checkbox-proposta-tecnica">APROVADO</label>
                                                                        <input id="checkbox-proposta-tecnica"
                                                                               name="propostaTecnica.status"
                                                                               type="radio" value="NEGADO"
                                                                               style="margin-left: 10%;"><label
                                                                            for="checkbox-proposta-tecnica">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                                ...
                                                                <c:if test="${projeto.documentosProjeto.propostaTecnica.status eq 'NEGADO'}">
                                                                    ...
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-proposta-tecnica"
                                                                               name="propostaTecnica.status"
                                                                               type="radio" value="APROVADO"><label
                                                                            for="checkbox-proposta-tecnica">APROVADO</label>
                                                                        <input id="checkbox-proposta-tecnica"
                                                                               name="propostaTecnica.status"
                                                                               type="radio" value="NEGADO" checked
                                                        ...
                                                        <c:if test="${not empty projeto.documentosProjeto.propostOrcamentaria.path}">
                                                            ...
                                                            <input type="hidden" name="propostOrcamentaria.path"
                                                                   value="${projeto.documentosProjeto.propostOrcamentaria.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${projeto.documentosProjeto.propostOrcamentaria.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            href="${path}/${projeto.documentosProjeto.propostOrcamentaria.path}"
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Planilha Orçamentária</a>
                                                                    </td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-proposta-orcamentaria"
                                                                               name="propostOrcamentaria.status"
                                                                               type="radio" value="APROVADO"
                                                                               checked><label
                                                                            for="checkbox-proposta-orcamentaria">APROVADO</label>
                                                                        <input id="checkbox-proposta-orcamentaria"
                                                                               name="propostOrcamentaria.status"
                                                                               type="radio" value="NEGADO"
                                                                               style="margin-left: 10%;"><label
                                                                            for="checkbox-proposta-orcamentaria">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                        ...
                                                        <c:if test="${projeto.documentosProjeto.dadosBancariosFundo.status ne 'NAO_SE_APLICA'}">
                                                            ...
                                                            <input type="hidden" name="dadosBancariosFundo.path"
                                                                   value="${projeto.documentosProjeto.dadosBancariosFundo.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${projeto.documentosProjeto.dadosBancariosFundo.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            href="${path}/${projeto.documentosProjeto.dadosBancariosFundo.path}"
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Dados Bancários do
                                                                        Fundos</a></td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-dados-bancarios-fundo"
                                                                               name="dadosBancariosFundo.status"
                                                                               type="radio" value="APROVADO"
                                                                               checked><label
                                                                            for="checkbox-dados-bancarios-fundo">APROVADO</label>
                                                                        <input id="checkbox-dados-bancarios-fundo"
                                                                               name="dadosBancariosFundo.status"
                                                                               type="radio" value="NEGADO"
                                                                               style="margin-left: 10%;"><label
                                                                            for="checkbox-dados-bancarios-fundo">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                        ...
                                                        <c:if test="${not empty projeto.documentosProjeto.certificado.path}">
                                                            ...
                                                            <input type="hidden" name="certificado.path"
                                                                   value="${projeto.documentosProjeto.certificado.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${projeto.documentosProjeto.certificado.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            href="${path}/${projeto.documentosProjeto.certificado.path}"
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Certificado</a></td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-certificado"
                                                                               name="certificado.status" type="radio"
                                                                               value="APROVADO" checked><label
                                                                            for="checkbox-certificado">APROVADO</label>
                                                                        <input id="checkbox-certificado"
                                                                               name="certificado.status" type="radio"
                                                                               value="NEGADO" style="margin-left: 10%;"><label
                                                                            for="checkbox-certificado">NEGADO</label>
                                                                    </td>
                                                                </c:if>
