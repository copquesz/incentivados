                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header ">
                            ...
                            <p><small style="color: red; font-weight: bold;"><i class="far fa-thumbs-up"></i>
                                Avaliado(s): ${qtdAvaliados}</small><small style="color: red; font-weight: bold;"
                                                                           class="mx-2"><i
                                    class="fas fa-grip-lines-vertical"></i></small><small
                                    style="color: red; font-weight: bold;"> <i class="far fa-thumbs-down"></i>
                                Pendentes(s): ${qtdPendentes}</small></p>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <c:if test="${empty projetos.content}">
                                        <div class="alert alert-danger alert-with-icon alert-dismissible fade show mt-2"
                                                    ...
                                                    <ul class="pagination">
                                                        <c:choose>
                                                            <c:when test="${projetos.totalPages == 1}">
                                                                <li class="page-item">
                                                                    <button class="page-link text-primary" disabled>
                                                                        Primeira
                                                                    </button>
                                                                </li>
                                                                <li class="page-item active"><a
                                                                        class="page-link text-white"
                                                                        href="${path}/painel/projetos?page=${projetos.number}&categoria=${categoria.id}&key=${key}">${projetos.number + 1}</a>
                                                                </li>
                                                                <li class="page-item">
                                                                    <button class="page-link text-primary" disabled>
                                                                        Última
                                                            ...
                                                            <c:when test="${(projetos.totalPages == 2) && (projetos.number + 1 < projetos.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number + 1}&categoria=${categoria.id}&key=${key}">${projetos.number + 2}</a>
                                                                </li>
                                                                <li class="page-item">
                                                                    <button class="page-link text-primary" disabled>
                                                                        Última
                                                            ...
                                                            <c:when test="${(projetos.totalPages == 2) && (projetos.number + 1 == projetos.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number - 1}&categoria=${categoria.id}&key=${key}">${projetos.number}</a>
                                                                </li>
                                                                <li class="page-item active"><a
                                                                        class="page-link text-primary text-white"
                                                                        href="${path}/painel/projetos?page=${projetos.number}&categoria=${categoria.id}&key=${key}">${projetos.number + 1}</a>
                                                            ...
                                                            <c:when test="${(projetos.totalPages >= 3) && (projetos.number == 0)}">
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?categoria=${categoria.id}&key=${key}">Primeira</a>
                                                                </li>
                                                                <li class="page-item active"><a
                                                                        class="page-link text-white"
                                                                        href="${path}/painel/projetos?page=${projetos.number}&categoria=${categoria.id}&key=${key}">${projetos.number + 1}</a>
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number + 2}&categoria=${categoria.id}&key=${key}">${projetos.number + 3}</a>
                                                                </li>
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.totalPages - 1}&categoria=${categoria.id}&key=${key}">Última</a>
                                                                </li>
                                                            </c:when>
                                                            ...
                                                            <c:when test="${(projetos.totalPages >= 3) && (projetos.number + 1 == projetos.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number - 2}&categoria=${categoria.id}&key=${key}">${projetos.number - 1}</a>
                                                                </li>
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/projetos?page=${projetos.number - 1}&categoria=${categoria.id}&key=${key}">${projetos.number}</a>
                                                                </li>
                                                    ...
                                                    <div class="card border align-self-stretch flex-fill bd-highlight mt-3">
                                                        ...
                                                        <div class="card-footer">
                                                            <a href="${path}/painel/projetos/${projeto.id}"
                                                               class="btn btn-primary rounded my-2 mx-auto d-block"><i
                                                                    class="fas fa-angle-double-right"></i> Detalhes</a>
                                                            <c:if test="${projeto.avaliado}">
                                                                <a href="#"
                                                                   class="btn btn-primary rounded my-2 mx-auto d-block"><i
                                                                        class="far fa-thumbs-up"></i> Projeto
                                                                    Avaliado</a>
                                                            </c:if>
                                                            <c:if test="${not projeto.avaliado}">
                                                                <a href="${path}/painel/projetos/avaliacao/${projeto.id}"
                                                                   class="btn btn-danger rounded my-2 mx-auto d-block"><i
                                                                        class="far fa-hand-point-right"></i> Avaliar
                                                                    Projeto</a>
                                                            </c:if>
                                                        </div>
                                                    </div>
