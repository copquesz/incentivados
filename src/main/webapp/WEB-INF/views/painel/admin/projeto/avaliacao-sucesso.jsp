                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body bg-success">
                            <p class="text-white">O projeto <strong>${projeto.titulo}</strong> foi avaliado com sucesso.
                            </p>
                            <p><a href="${path}/painel/projetos" class="btn btn-warning"><i
                                    class="far fa-share-square"></i> Voltar</a></p>
                        </div>
