...
<script type="text/javascript">
    ...
    let dados = [<c:forEach var='am4ChartProjetosLocalidade' items='${am4ChartsProjetosLocalidade}'>{
        "id": '${am4ChartProjetosLocalidade.id}',
        "value": '${am4ChartProjetosLocalidade.value}'
    }, </c:forEach>];
