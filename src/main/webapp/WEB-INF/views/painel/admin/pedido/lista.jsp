                                                        ...
                                                        <td class="text-center border">
                                                            ...
                                                            <c:if test="${pedido.status.id == 3}"><span
                                                                    class="bg-success p-1"><a href="#"
                                                                                              ...
                                                                                              title="Visualizar Parecer - Pré Aprovado">PRÉ-APROVADO</a></span></c:if>
                                                        </td>
                                                        <td class="text-center border">
