        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">Incentivos Fiscais <i class='fas fa-angle-double-right'></i>
                        Cadastro</a></b>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body bg-success">
                            <p class="text-white">O item <strong>${incentivoFiscal.legislacao}</strong> atuante em
                                <strong>${incentivoFiscal.atuacao}</strong> foi cadastrado com sucesso na plataforma.
                            </p>
                            <p><a href="${path}/painel/incentivos-fiscais" class="btn btn-warning"><i
                                    class="far fa-share-square"></i> Ver Registros</a></p>
                        </div>
