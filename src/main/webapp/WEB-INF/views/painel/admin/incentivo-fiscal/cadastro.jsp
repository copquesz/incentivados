                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mt-5">
                                <div class="col-12">
                                    <form action="${path}/painel/incentivos-fiscais/cadastro" method="post"
                                          acceptcharset="UTF-8">
                                        <fieldset>
                                            ...
                                            <div class="row mt-3 mt-3">
                                                <div class="col-sm-12 col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="legislacao"
                                                               required>
                                                    </div>
                                                </div>
                                        ...
                                        <a href="${path}/painel/incentivos-fiscais"
                                           class="btn btn-danger float-right"><i class="fas fa-angle-double-left"></i>
                                            Voltar</a>
                                    </form>
                                </div>
                            </div>
