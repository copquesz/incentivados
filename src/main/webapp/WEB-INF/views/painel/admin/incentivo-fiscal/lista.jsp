                ...
                <div class="col-12">
                    <div class="card">
                                                ...
                                                <c:choose>
                                                    <c:when test="${incentivosFiscais.totalPages == 1}">
                                                        ...
                                                        <li class="page-item active"><a class="page-link text-white"
                                                                                        href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.number}">${incentivosFiscais.number + 1}</a>
                                                        </li>
                                                        <li class="page-item">
                                                    ...
                                                    <c:when test="${(incentivosFiscais.totalPages == 2) && (incentivosFiscais.number + 1 < incentivosFiscais.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.number + 1}">${incentivosFiscais.number + 2}</a>
                                                        </li>
                                                        <li class="page-item">
                                                            <button class="page-link text-primary" disabled>Última
                                                            </button>
                                                    ...
                                                    <c:when test="${(incentivosFiscais.totalPages == 2) && (incentivosFiscais.number + 1 == incentivosFiscais.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.number - 1}">${incentivosFiscais.number}</a>
                                                        </li>
                                                        <li class="page-item active"><a
                                                                class="page-link text-primary text-white"
                                                                href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.number}">${incentivosFiscais.number + 1}</a>
                                                    ...
                                                    <c:when test="${(incentivosFiscais.totalPages >= 3) && (incentivosFiscais.number == 0)}">
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/incentivosFiscais">Primeira</a>
                                                        </li>
                                                        <li class="page-item active"><a class="page-link text-white"
                                                                                        href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.number}">${incentivosFiscais.number + 1}</a>
                                                        </li>
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.number + 2}">${incentivosFiscais.number + 3}</a>
                                                        </li>
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.totalPages - 1}">Última</a>
                                                        </li>
                                                    </c:when>
                                                    ...
                                                    <c:when test="${(incentivosFiscais.totalPages >= 3) && (incentivosFiscais.number + 1 == incentivosFiscais.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.number - 2}">${incentivosFiscais.number - 1}</a>
                                                        </li>
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/incentivos-fiscais?page=${incentivosFiscais.number - 1}">${incentivosFiscais.number}</a>
                                                        </li>
                                                ...
                                                <c:forEach var="incentivoFiscal" items="${incentivosFiscais.content}">
                                                    <tr>
                                                        <td class="border text-center"
                                                            scope="row">${incentivoFiscal.id}</td>
                                                        <td class="border text-center">${incentivoFiscal.legislacao}
                                                            <c:if test="${not empty incentivoFiscal.sigla}"> - ${incentivoFiscal.sigla}</c:if></td>
                                                        <td class="border text-center">${incentivoFiscal.competencia.descricao}
                                                            <c:if test="${not empty incentivoFiscal.localidade}">
                                                            - ${incentivoFiscal.localidade}</c:if></td>
                                                        <td class="border text-center"
                                                            scope="row">${incentivoFiscal.atuacao.descricao}</td>
                                                    </tr>
                                                </c:forEach>
                                                </tbody>
                                            </table>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="${path}/painel/incentivos-fiscais/cadastro" class="btn btn-primary mr-5">Cadastrar
                                        Incentivos Fiscal</a>
                                </div>
                            </div>
                        </div>
