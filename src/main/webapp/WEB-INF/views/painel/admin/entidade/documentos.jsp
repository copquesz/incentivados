            ...
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">Entidade <i
                            class='fas fa-angle-double-right'></i> ${entidade.nomeFantasia} <i
                            class='fas fa-angle-double-right'></i> Documentos</a></b>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="${path}/painel/entidades/${entidade.id}/documentos/analise" method="post"
                              acceptcharset="UTF-8" id="formulario-analise-documentos-entidade">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <c:if test="${not empty entidade.documentosEntidade.logo.path}">
                                                            <input type="hidden" name="logo.id"
                                                                   value="${entidade.documentosEntidade.logo.id}">
                                                            <input type="hidden" name="logo.path"
                                                                   value="${entidade.documentosEntidade.logo.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${entidade.documentosEntidade.logo.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            ...
                                                                            title="Visualizar">Logo</a></td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-logo" name="logo.status"
                                                                               type="radio" value="APROVADO"
                                                                               checked><label for="checkbox-logo">APROVADO</label>
                                                                        <input id="checkbox-logo" name="logo.status"
                                                                               type="radio" value="NEGADO"
                                                                               style="margin-left: 10%;"><label
                                                                            for="checkbox-logo">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                                ...
                                                                <c:if test="${entidade.documentosEntidade.logo.status eq 'NEGADO'}">
                                                                    ...
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-logo" name="logo.status"
                                                                               ...
                                                                               checked><label for="checkbox-logo">APROVADO</label>
                                                                        <input id="checkbox-logo" name="logo.status"
                                                                               type="radio" value="NEGADO" checked
                                                                               style="margin-left: 10%;"><label
                                                                            for="checkbox-logo">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                        ...
                                                        <c:if test="${not empty entidade.documentosEntidade.ataEleicao.path}">
                                                            <input type="hidden" name="ataEleicao.id"
                                                                   value="${entidade.documentosEntidade.ataEleicao.id}">
                                                            <input type="hidden" name="ataEleicao.path"
                                                                   value="${entidade.documentosEntidade.ataEleicao.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${entidade.documentosEntidade.ataEleicao.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            ...
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Ata de Eleição</a></td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-ata-eleicao"
                                                                               name="ataEleicao.status" type="radio"
                                                                               value="APROVADO" checked><label
                                                                            for="checkbox-ata-eleicao">APROVADO</label>
                                                                        <input id="checkbox-ata-eleicao"
                                                                               name="ataEleicao.status" type="radio"
                                                                               value="NEGADO" style="margin-left: 10%;"><label
                                                                            for="checkbox-ata-eleicao">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                        ...
                                                        <c:if test="${not empty entidade.documentosEntidade.estatutoSocial.path}">
                                                            <input type="hidden" name="estatutoSocial.id"
                                                                   value="${entidade.documentosEntidade.estatutoSocial.id}">
                                                            <input type="hidden" name="estatutoSocial.path"
                                                                   value="${entidade.documentosEntidade.estatutoSocial.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${entidade.documentosEntidade.estatutoSocial.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            ...
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Estatuto Social /
                                                                        Contrato Social</a></td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-estatuto-social"
                                                                               name="estatutoSocial.status" type="radio"
                                                                               value="APROVADO" checked><label
                                                                            for="checkbox-estatuto-social">APROVADO</label>
                                                                        <input id="checkbox-estatuto-social"
                                                                               name="estatutoSocial.status" type="radio"
                                                                               value="NEGADO" style="margin-left: 10%;"><label
                                                                            for="checkbox-estatuto-social">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                        ...
                                                        <c:if test="${not empty entidade.documentosEntidade.identidade.path}">
                                                            <input type="hidden" name="identidade.id"
                                                                   value="${entidade.documentosEntidade.identidade.id}">
                                                            <input type="hidden" name="identidade.path"
                                                                   value="${entidade.documentosEntidade.identidade.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${entidade.documentosEntidade.identidade.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            ...
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Identidade Presidente</a>
                                                                    </td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-identidade"
                                                                               name="identidade.status" type="radio"
                                                                               value="APROVADO" checked><label
                                                                            for="checkbox-identidade">APROVADO</label>
                                                                        <input id="checkbox-identidade"
                                                                               name="identidade.status" type="radio"
                                                                               value="NEGADO" style="margin-left: 10%;"><label
                                                                            for="checkbox-identidade">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                        ...
                                                        <c:if test="${not empty entidade.documentosEntidade.cartaoCnpj.path}">
                                                            <input type="hidden" name="cartaoCnpj.id"
                                                                   value="${entidade.documentosEntidade.cartaoCnpj.id}">
                                                            <input type="hidden" name="cartaoCnpj.path"
                                                                   value="${entidade.documentosEntidade.cartaoCnpj.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${entidade.documentosEntidade.cartaoCnpj.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            ...
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Cartão CNPJ</a></td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-cartao-cnpj"
                                                                               name="cartaoCnpj.status" type="radio"
                                                                               value="APROVADO" checked><label
                                                                            for="checkbox-cartao-cnpj">APROVADO</label>
                                                                        <input id="checkbox-cartao-cnpj"
                                                                               name="cartaoCnpj.status" type="radio"
                                                                               value="NEGADO" style="margin-left: 10%;"><label
                                                                            for="checkbox-cartao-cnpj">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                                        ...
                                                        <c:if test="${not empty entidade.documentosEntidade.dadosBancarios.path}">
                                                            <input type="hidden" name="dadosBancarios.id"
                                                                   value="${entidade.documentosEntidade.dadosBancarios.id}">
                                                            <input type="hidden" name="dadosBancarios.path"
                                                                   value="${entidade.documentosEntidade.dadosBancarios.path}">
                                                            <tr>
                                                                ...
                                                                <c:if test="${entidade.documentosEntidade.dadosBancarios.status eq 'PENDENTE'}">
                                                                    <td class="border text-center"><a
                                                                            ...
                                                                            target="_blank"
                                                                            class="btn btn-warning btn-sm text-white"
                                                                            title="Visualizar">Dados Bancários</a></td>
                                                                    <td class="border text-center">
                                                                        <input id="checkbox-dados-bancarios"
                                                                               name="dadosBancarios.status" type="radio"
                                                                               value="APROVADO" checked><label
                                                                            for="checkbox-dados-bancarios">APROVADO</label>
                                                                        <input id="checkbox-dados-bancarios"
                                                                               name="dadosBancarios.status" type="radio"
                                                                               value="NEGADO" style="margin-left: 10%;"><label
                                                                            for="checkbox-dados-bancarios">NEGADO</label>
                                                                    </td>
                                                                </c:if>
                                        ...
                                        <div class="row" id="campo-parecer">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <label>Parecer:</label>
                                                    <textarea class="form-control text-justify" name="analise" rows="10"
                                                              maxlength="3000"
                                                              placeholder="Descreva sua o motivo pelo qual o(s) documento(s) está sendo negado ..."></textarea>
                                                </div>
                                            </div>
                                        </div>
