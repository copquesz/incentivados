                            ...
                            <div class="row d-flex justify-content-end">
                                <div class="col-12">
                                    <form class="form-inline">
                                        <input type="text" class="form-control my-auto mr-2" name="key"
                                               placeholder="Pesquisar por Nome Fantazia ou CNPJ ...">
                                        <button type="submit" class="btn btn-primary my-auto"><i
                                                ...
                                                <c:choose>
                                                    <c:when test="${empresas.totalPages == 1}">
                                                        ...
                                                        <li class="page-item active"><a class="page-link text-white"
                                                                                        href="${path}/painel/empresas?page=${empresas.number}&key=${key}">${empresas.number + 1}</a>
                                                        </li>
                                                        <li class="page-item">
                                                    ...
                                                    <c:when test="${(empresas.totalPages == 2) && (empresas.number + 1 < empresas.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/empresas?page=${empresas.number + 1}&key=${key}">${empresas.number + 2}</a>
                                                        </li>
                                                        <li class="page-item">
                                                            <button class="page-link text-primary" disabled>Última
                                                            </button>
                                                    ...
                                                    <c:when test="${(empresas.totalPages == 2) && (empresas.number + 1 == empresas.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/empresas?page=${empresas.number - 1}&key=${key}">${empresas.number}</a>
                                                        </li>
                                                        <li class="page-item active"><a
                                                                class="page-link text-primary text-white"
                                                                href="${path}/painel/empresas?page=${empresas.number}&key=${key}">${empresas.number + 1}</a>
                                                    ...
                                                    <c:when test="${(empresas.totalPages >= 3) && (empresas.number == 0)}">
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/empresas?page=0&key=${key}">Primeira</a>
                                                        </li>
                                                        <li class="page-item active"><a class="page-link text-white"
                                                                                        href="${path}/painel/empresas?page=${empresas.number}&key=${key}">${empresas.number + 1}</a>
                                                        </li>
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/empresas?page=${empresas.number + 2}&key=${key}">${empresas.number + 3}</a>
                                                        </li>
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/empresas?page=${empresas.totalPages - 1}&key=${key}">Última</a>
                                                        </li>
                                                    </c:when>
                                                    ...
                                                    <c:when test="${(empresas.totalPages >= 3) && (empresas.number + 1 == empresas.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/empresas?page=${empresas.number - 2}&key=${key}">${empresas.number - 1}</a>
                                                        </li>
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/empresas?page=${empresas.number - 1}&key=${key}">${empresas.number}</a>
                                                        </li>
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <c:forEach var="empresa" items="${empresas.content}">
                                                    <tr>
                                                        <td class="border text-center"><img
                                                                class="img-fluid rounded mx-auto d-block"
                                                                src="${path}/${empresa.documentosEmpresa.logo.path}"
                                                        ...
                                                        <td class="border text-center">
                                                            <a href="${path}/painel/empresas/${empresa.id}"
                                                               class="btn btn-primary btn-sm text-branco"
                                                               title="Visualizar">
