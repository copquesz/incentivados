                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item btn-rotate dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="${path}/painel/perfi#${path}/painel/perfil"
                                   data-toggle="modal" data-target="#modal-alterar-senha">Alterar Senha</a>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body bg-danger">
                            <p class="text-white"><span class="bold">CPF: ${usuario.cpf}</span> já possui registro na
