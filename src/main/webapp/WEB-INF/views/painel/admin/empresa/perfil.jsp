        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">Empresa <i
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body border">
                            <fieldset>
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-4 text-center">
                                        <figure class="figure">
                                            <img class="img-fluid" src="${path}/${empresa.documentosEmpresa.logo.path}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           value="${empresa.razaoSocial}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           value="${empresa.nomeFantasia}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                            ...
                            <hr class="bg-success">
                            <div class="dropdown">
                                <button class="btn btn-primary dropdown-toggle float-left" type="button"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Cadastrar
                                </button>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item"
                                       href="${path}/painel/empresas/${empresa.id}/analistas/cadastro">Analista</a>
                                    <a class="dropdown-item"
                                       href="${path}/painel/empresas/${empresa.id}/responsavel/cadastro">Responsável</a>
                                </div>
                            </div>
                            <a href="${path}/painel/empresas" class="btn btn-warning float-left"><i
