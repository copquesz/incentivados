        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body bg-danger">
              ...
              <p><a href="${path}/painel/empresas/cadastro" class="btn btn-warning rounded"><i class="fas fa-angle-double-left"></i> Voltar</a><a href="${path}/painel/empresas" class="btn btn-warning rounded  ml-2"><i class="fas fa-list-ul"></i> Ver Registros</a></p>
            </div>
