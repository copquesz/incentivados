    ...
    <div class="sidebar" data-color="verde" data-active-color="white">
      <div class="logo">
        <a href="#" class="simple-text logo-mini">
            <div class="logo-image-small"><i class="far fa-user"></i>
            </div>
        </a>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body bg-danger">
                <p class="text-white"><span class="bold">CNPJ: ${empresa.cnpj}</span> já possui registro na plataforma. Tente novamente informando outros dados.</p>
