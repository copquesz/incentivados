    ...
    <div class="main-panel">
      ...
      <div class="content">        
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header"><h4 class="card-title text-white bold"><i class="far fa-thumbs-down fa-2x"></i> Falha!</h4><hr></div>              
              <div class="card-body">
                <p><span class="bold">CNPJ: ${empresa.cnpj}</span> já possui registro na plataforma. Tente novamente informando outros dados.</p>
