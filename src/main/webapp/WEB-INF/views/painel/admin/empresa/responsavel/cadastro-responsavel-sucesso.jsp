...
<head>
    ...
    <title>
        Incentivados - Cadastro de Responsável
    </title>
            ...
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">Empresa <i
                            ...
                            class='fas fa-angle-double-right'></i> Responsável <i class='fas fa-angle-double-right'></i>
                        Cadastro</a></b>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body bg-success">
                            <p class="text-white bold">Responsável: ${usuario.nome} ${usuario.sobrenome}</br>
                                CPF: ${usuario.cpf}</br>E-mail: ${usuario.email}</p>
