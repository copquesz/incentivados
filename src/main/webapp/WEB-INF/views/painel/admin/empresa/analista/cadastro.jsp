      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <b><a class="navbar-brand" href="#">Empresa <i class='fas fa-angle-double-right'></i> ${empresa.nomeFantasia} <i class='fas fa-angle-double-right'></i> Analista <i class='fas fa-angle-double-right'></i> Cadastro</a></b>
          </div>
