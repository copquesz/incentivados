            ...
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">Empresa <i
                            ...
                            class='fas fa-angle-double-right'></i> Analista <i class='fas fa-angle-double-right'></i>
                        Cadastro</a></b>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body border">
                            <form action="${path}/painel/empresas/${empresa.id}/analistas/cadastro" method="post"
                                  acceptcharset="UTF-8">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group">
                                                <label>Nome:</label>
                                                <input type="text" class="form-control text-capitalize" name="nome"
                                                       required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control text-capitalize" name="sobrenome"
                                                       required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                ...
                                <a href="${path}/painel/empresas/${empresa.id}" class="btn btn-danger float-right"><i
