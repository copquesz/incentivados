                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control"
                                                   value="${usuario.tipoUsuario.descricao}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                            ...
                            <fieldset class="mt-3 mt-3">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label>CEP:</label>
                                            <input type="text" class="form-control" value="${usuario.endereco.cep}"
                                    ...
                                    <div class="col-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="${usuario.endereco.logradouro}" placeholder="Não Informado"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                                            <label>Nº:</label>
                                            <input type="text" class="form-control" value="${usuario.endereco.numero}"
                                                   placeholder="Não Informado" readonly>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="${usuario.endereco.complemento}" placeholder="Não Informado"
                                                   readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bairro"
                                                   value="${usuario.endereco.bairro}" placeholder="Não Informado"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cidade"
                                                   value="${usuario.endereco.cidade}" placeholder="Não Informado"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="estado"
                                                   value="${usuario.endereco.estado}" placeholder="Não Informado"
                                                   readonly>
                                        </div>
                                    </div>
                                </div>
