        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">${usuario.empresa.nomeFantasia} <i
                            class='fas fa-angle-double-right'></i> Pedido <i class='fas fa-angle-double-right'></i>
                        #${pedido.id}</a></b>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body border">
                            <form action="${path}/painel/pedidos/${empresa.nomeFantasia}/cadastro" method="post"
                                ...
                                <fieldset>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="${pedido.usuario.nome} ${pedido.usuario.sobrenome}"
                                                       readonly>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>E-mail:</label>
                                                <input type="text" class="form-control" value="${pedido.usuario.email}"
                                                       readonly>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>CPF:</label>
                                                <input type="text" class="form-control" value="${pedido.usuario.cpf}"
                                                       readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="${pedido.tipoPedido.descricao}" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label>Entidade:</label>
                                            <input type="text" class="form-control"
                                                   value="${pedido.entidade.nomeFantasia}" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" placeholder="Não Informado"
                                                          readonly>${pedido.solicitacao}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="mt-5">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="${pedido.entidade.razaoSocial}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>CNPJ:</label>
                                                <input type="text" class="form-control" value="${pedido.entidade.cnpj}"
                                                       readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <label>Loja:</label>
                                            <input type="text" class="form-control"
                                                   value="${pedido.analista.endereco.bairro} ( ${pedido.analista.endereco.cidade} / ${pedido.analista.endereco.estado} )"
                                                   readonly>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="mt-5 mb-5">
                                    ...
                                    <div class="row justify-content-start">
                                        <div class="col-lg-2 text-center mt-5">
                                            <div class="form-group">
                                                <a href="${path}/${pedido.documentosPedido.cartaOficio.path}"
                                                   target="_blank"><i class="far fa-file-alt text-primary"
                                        ...
                                        <div class="col-lg-2 text-center mt-5">
                                            <div class="form-group">
                                                <a href="${path}/${pedido.entidade.documentosEntidade.cartaoCnpj.path}"
                                ...
                                <a href="#" class="btn btn-danger float-right" data-toggle="modal"
                                   data-target="#modal-reprovar-pedido">Reprovar <i class="far fa-thumbs-down"></i></a>
                                <a href="" class="btn btn-success float-right" data-toggle="modal"
                                   data-target="#modal-aprovar-pedido">Aprovar <i class="far fa-thumbs-up"></i></a>
                                <a href="${path}/painel/dashboard" class="btn btn-warning float-left"><i
