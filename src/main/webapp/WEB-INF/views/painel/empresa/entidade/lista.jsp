                                    ...
                                    <form class="form-inline">
                                        <div class="form-group mx-sm-3 mb-2">
                                            <input type="text" class="form-control"
                                                   placeholder="CNPJ ou Nome Fantasia ..." name="key">
                                        </div>
                                                ...
                                                <c:choose>
                                                    <c:when test="${entidades.totalPages == 1}">
                                                        ...
                                                        <li class="page-item active"><a class="page-link text-white"
                                                                                        href="${path}/painel/entidades?page=${entidades.number}">${entidades.number + 1}</a>
                                                        </li>
                                                        <li class="page-item">
                                                    ...
                                                    <c:when test="${(entidades.totalPages == 2) && (entidades.number + 1 < entidades.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/entidades?page=${entidades.number + 1}">${entidades.number + 2}</a>
                                                        </li>
                                                        <li class="page-item">
                                                            <button class="page-link text-primary" disabled>Última
                                                            </button>
                                                    ...
                                                    <c:when test="${(entidades.totalPages == 2) && (entidades.number + 1 == entidades.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/entidades?page=${entidades.number - 1}">${entidades.number}</a>
                                                        </li>
                                                        <li class="page-item active"><a
                                                                class="page-link text-primary text-white"
                                                                href="${path}/painel/entidades?page=${entidades.number}">${entidades.number + 1}</a>
                                                    ...
                                                    <c:when test="${(entidades.totalPages >= 3) && (entidades.number == 0)}">
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/entidades">Primeira</a>
                                                        </li>
                                                        <li class="page-item active"><a class="page-link text-white"
                                                                                        href="${path}/painel/entidades?page=${entidades.number}">${entidades.number + 1}</a>
                                                        </li>
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/entidades?page=${entidades.number + 2}">${entidades.number + 3}</a>
                                                        </li>
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/entidades?page=${entidades.totalPages - 1}">Última</a>
                                                        </li>
                                                    </c:when>
                                                    ...
                                                    <c:when test="${(entidades.totalPages >= 3) && (entidades.number + 1 == entidades.totalPages)}">
                                                        ...
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/entidades?page=${entidades.number - 2}">${entidades.number - 1}</a>
                                                        </li>
                                                        <li class="page-item"><a class="page-link text-primary"
                                                                                 href="${path}/painel/entidades?page=${entidades.number - 1}">${entidades.number}</a>
                                                        </li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="border text-center">
                                                            <a href="${path}/painel/entidades/${entidade.id}"
                                                               ...
                                                               title="Visualizar"><i
                                                                    class="far fa-address-card"></i></a></td>
                                                    </tr>
                                                </c:forEach>
                                                </tbody>
                                            </table>
