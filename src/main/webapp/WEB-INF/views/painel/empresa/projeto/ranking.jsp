                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <c:if test="${empty projetos.content}">
                                        <div class="alert alert-info alert-with-icon alert-dismissible fade show mt-2"
                                                        ...
                                                        <c:forEach var="projeto" items="${projetos.content}">
                                                            <c:if test="${projeto.qtdAvaliacoes != 0}">
                                                                <tr>
                                                                    ...
                                                                    <td class="border text-center"><fmt:formatNumber
                                                                            maxFractionDigits="2"
                                                                            value="${projeto.notaTecnica}"></fmt:formatNumber></td>
                                                                    <td class="border text-center"><fmt:formatNumber
                                                                            maxFractionDigits="2"
                                                                            value="${projeto.notaInstitucional}"></fmt:formatNumber></td>
                                                                    <td class="border text-center"><fmt:formatNumber
                                                                            maxFractionDigits="2"
                                                                            value="${projeto.notaGeral}"></fmt:formatNumber></td>
