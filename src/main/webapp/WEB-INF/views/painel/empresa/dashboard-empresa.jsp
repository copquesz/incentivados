                                                    ...
                                                    <table class="table border">
                                                        ...
                                                        <c:forEach var="pedidosRecusado" items="${recusados.content}">
                                                            <tr>
                                                                ...
                                                                <fmt:formatDate type="both" dateStyle="short"
                                                                                timeStyle="short"
                                                                                value="${pedidosRecusado.dataCadastro}"
                                                                                var="dataCadastro"/>
                                                                <td class="text-center border">${dataCadastro}</td>
                                                                ...
                                                                <td class="text-center border">${pedidosRecusado.analista.endereco.bairro}
                                                                    - ${pedidosRecusado.analista.endereco.cidade}
                                                                    / ${pedidosRecusado.analista.endereco.estado}</td>
                                                                <td class="text-center border">${pedidosRecusado.tipoPedido.descricao}</td>
                                                                <td class="text-center border"><a href="#"
                                                                                                  data-toggle="modal"
                                                                                                  data-target="#modal-observacao-pedido-recusado-${pedidosRecusado.id}"
                                                                                                  title="Visualizar"><i
                                                                        class="far fa-file-pdf"></i></a></td>
                                                            </tr>
                                                        </c:forEach>
