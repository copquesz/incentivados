...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <b><a class="navbar-brand" href="#">Gráficos <i class='fas fa-angle-double-right'></i> Projetos <i class='fas fa-angle-double-right'></i> Categoria</a></b>
          </div>
          ...
          <div class="col-md-10 mx-auto">
            <div class="card ">
              <div class="card-header ">
                <h5 class="card-title">Projetos x Categorias</h5>                
              </div>
              <div class="card-body ">                
                <canvas id="projeto-pie-chart"></canvas>
              </div>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">    
    var pieCtx = document.getElementById("projeto-pie-chart").getContext('2d');
