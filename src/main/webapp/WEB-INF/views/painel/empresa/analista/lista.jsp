            ...
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <b><a class="navbar-brand" href="#">${usuario.empresa.nomeFantasia} <i
                            class='fas fa-angle-double-right'></i> Analistas</b>
                </div>
                        ...
                        <div class="card-body">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${analistas.totalPages == 1}">
                                                                ...
                                                                <li class="page-item active"><a
                                                                        ...
                                                                        href="${path}/painel/${empresa.id}/analistas?page=${analistas.number}&key=">${analistas.number + 1}</a>
                                                                </li>
                                                                <li class="page-item">
                                                                    <button class="page-link text-primary" disabled>
                                                                        Última
                                                            ...
                                                            <c:when test="${(analistas.totalPages == 2) && (analistas.number + 1 < analistas.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/${empresa.id}/analistas?page=${analistas.number + 1}&key=">${analistas.number + 2}</a>
                                                                </li>
                                                                <li class="page-item">
                                                                    <button class="page-link text-primary" disabled>
                                                                        Última
                                                            ...
                                                            <c:when test="${(analistas.totalPages == 2) && (analistas.number + 1 == analistas.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/${empresa.id}/analistas?page=${analistas.number - 1}&key=">${analistas.number}</a>
                                                                </li>
                                                                <li class="page-item active"><a
                                                                        class="page-link text-primary text-white"
                                                                        href="${path}/painel/${empresa.id}/analistas?page=${analistas.number}&key=">${analistas.number + 1}</a>
                                                            ...
                                                            <c:when test="${(analistas.totalPages >= 3) && (analistas.number == 0)}">
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/${empresa.id}/analistas?key=">Primeira</a>
                                                                </li>
                                                                <li class="page-item active"><a
                                                                        class="page-link text-white"
                                                                        href="${path}/painel/${empresa.id}/analistas?page=${analistas.number}&key=">${analistas.number + 1}</a>
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/${empresa.id}/analistas?page=${analistas.number + 2}&key=">${analistas.number + 3}</a>
                                                                </li>
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/${empresa.id}/analistas?page=${analistas.totalPages - 1}&key=">Última</a>
                                                                </li>
                                                            </c:when>
                                                            <c:when test="${(analistas.totalPages >= 3) && (analistas.number > 0) && (analistas.number + 1 < analistas.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/analistas?page=${analistas.totalPages - 1}&key=">Última</a>
                                                                </li>
                                                            </c:when>
                                                            <c:when test="${(analistas.totalPages >= 3) && (analistas.number + 1 == analistas.totalPages)}">
                                                                ...
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/${empresa.id}/analistas?page=${analistas.number - 2}&key=">${analistas.number - 1}</a>
                                                                </li>
                                                                <li class="page-item"><a class="page-link text-primary"
                                                                                         href="${path}/painel/${empresa.id}/analistas?page=${analistas.number - 1}&key=">${analistas.number}</a>
                                                                </li>
                                                ...
                                                <c:forEach var="analista" items="${analistas.content}">
                                                    <tr>
                                                        ...
                                                        <td class="border text-center"
                                                            title="Cidade: ${analista.endereco.cidade} / Estado: ${analista.endereco.estado}"> ${analista.endereco.bairro}</td>
                                                    </tr>
                                                </c:forEach>
                                                </tbody>
                                            </table>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-12">
                                    ...
                                    <a class="btn btn-info" href="${path}/painel/dashboard"><i
