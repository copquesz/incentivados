  ...
  <div class="container h-100">    
     <div class="d-flex justify-content-center h-100" style="margin-top: 30%;">
       <div class="alert alert-success bg-success" role="alert">
         <h1 class="alert-heading"><strong>Cadastro Realizado!</strong></h1>
         ...
         <c:if test="${redirect eq ''}">
          <p class="mb-0 lead">Clique<a href='${path}/login'><strong> <u>aqui</u></strong></a> para acessar a plataforma!</p>
         </c:if>
         <c:if test="${redirect ne ''}">
          <p class="mb-0 lead">Clique<a href='${path}/login?redirect=${redirect}'><strong> <u>aqui</u></strong></a> para acessar a plataforma!</p>
         </c:if>
       </div>
     </div>    
  </div>
