  ...
  <div class="container h-100">    
      <div class="d-flex justify-content-center h-100" style="margin-top: 30%;">
        <div class="alert alert-danger bg-danger" role="alert">
          ...
          <h1 class="alert-heading"><strong>Falha!</strong></h1>
          <p class="lead">O cadastro foi não realizado devido a algum erro inesperado.</p>
          <p class="lead">Favor contate nosso suporte através do email <strong>claro@incentivados.com.br</strong>.</p>
          <hr>
          <p class="mb-0 lead">Clique<a href="${path}/login"><strong> <u>aqui</u></strong></a> para voltar.</p>
        </div>
      </div>
  </div>
</body>
