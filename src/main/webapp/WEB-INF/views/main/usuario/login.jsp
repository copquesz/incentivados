    ...
    <div class="d-flex justify-content-center h-100 d-inline-block">
        <div class="login_card">
            <div class="d-flex justify-content-center">
                <div class="login_image bg-white rounded-circle" style="border: 1.5px solid #051832 !important">
                    <img src="${path}/assets/img/favicon.png" class="login_user_image img-fluid" alt="Logo">
                </div>
            </div>
