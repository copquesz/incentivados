...
public class PedidoService {
    ...
    public Page<Pedido> findAllByEmpresaAndLojaAndStatus(Empresa empresa, String key, StatusPedido status, Pageable page) {
        return this.pedidoRepository.findAllByEmpresaAndLojaAndStatus(empresa, key, status, page);
    }

    public Page<Pedido> findAllByEmpresaAndCidadeAndStatus(Empresa empresa, String key, StatusPedido status, Pageable page) {
        return this.pedidoRepository.findAllByEmpresaAndLojaAndStatus(empresa, key, status, page);
    }
